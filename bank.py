...
def get_client_username():
    ...
    if check_client_username(user_name) != True:
        time.sleep(1)
...
def get_client_password(user_name, repetition):
    ...
    if password == '0':
        get_client_username()
    if check_client_password(user_name, password) != True:
...
def get_employee_username():
    ...
    if check_employee_user_name(user_name) != True:
        time.sleep(1)
...
def get_employee_password(user_name):
    ...
    if password == '0':
        get_employee_username()
    if check_employee_password(user_name, password) == False:
